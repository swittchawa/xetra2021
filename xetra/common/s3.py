...
class S3BucketConnector():
    ...
    """
    def __init__(self, access_key: str, secrect_key: str, endpoint_url: str, bucket: str):
        """
        ...
        self.session = boto3.Session(aws_access_key_id=os.environ[access_key],
                                     aws_secret_access_key=os.environ[secrect_key])
    ...
    def read_csv_to_df(self, key: str, decoding: str = 'utf-8', sep: str = ','):
        ...
        csv_object = self._bucket.Object(key=key).get().get('Body').read().decode(decoding)
    ...
    def __put_object(self, out_buffer: StringIO or BytesIO, key: str):
        """
        Help function for self.write_df_to_s3()
