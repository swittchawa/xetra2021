...
class MetaProcess():
    ...
    def update_meta_file(extract_date_list: list, meta_key: str, s3_bucket_meta: S3BucketConnector):
        """ 
        Updating the meta file with the processed Xetra dates and today date as processed date

        :param: extract_date_list -> a list of dates that are are extracted from the source
    ...
    def return_date_list(first_date: str, meta_key: str, s3_bucket_meta: S3BucketConnector):
        ...
        :param: meta_key -> key of the meta file on the S3 bucket
        :param: s3_bucket_meta -> S3BucketConnector of the bucket with the meta file
        ...
        try:
            # If meta file is exists create return_date_list using the content of the meta file
            # Reading meta file
            ...
            if dates_missing:
                # Determining the earlist date that should be extracted
