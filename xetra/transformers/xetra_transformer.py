...
class XetraSourceConfig(NamedTuple):
    ...
    src_col_max_price: column name for maximum in source
...
class XetraETL():
    ...
    def transform_report1(self):
        ...
        """
        if data_frame.empty(self):
            self._logger.info("The dataframe is empty. No transformation will be applied")
            return data_frame
        self._logger.info('Applying transformation to Xetra source data for report 1 start...')
        ...
        # Aggregating per ISIN and day -> openning price, closing price,
        # minimum price, maximum price, traded volumn
        ...
        # previous traiding day's closing price in %
