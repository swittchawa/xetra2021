...
class TestMetaProcessMethods(unittest.TestCase):
    ...
    def test_update_meta_file_no_meta_file(self):
        """
        Tests the update meta_file method
    ...
    def test_update_meta_file_file_ok(self):
        """
        Tests the update_meta_file method
    ...
    def test_return_date_list_no_meta_file(self):
        ...
        date_list_exp = [
            (datetime.today().date() - timedelta(days=day))\
                .strftime(MetaProcessFormat.META_DATE_FORMAT.value) for dat in range(4)
            ]
    ...
    def test_return_date_list_meta_file_ok(self):
        ...
        # Expected results
        min_date_exp = [
            (datetime.todaty().date() - timedelta(days=1))\
                .strftime(MetaProcessFormat.META_DATE_FORMAT.value),
            (datetime.todaty().date() - timedelta(days=2))\
                .strftime(MetaProcessFormat.META_DATE_FORMAT.value),
            (datetime.todaty().date() - timedelta(days=3))\
                .strftime(MetaProcessFormat.META_DATE_FORMAT.value)
        ]
        date_list_exp = [
            [(datetime.today().date() - timedelta(days=day))\
