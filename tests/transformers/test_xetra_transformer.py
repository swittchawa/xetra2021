...
class TextXetraETLMethods(unittest.TestCase):
    ...
    def test_extract_files(self):
        ...
        # Method execution
        with patch.object(MetaProcess, "return_dateList",
        return_value=[extract_date, extract_date_list]):
            xetra_etl = XetraETL(self.s3_bucket_src, self.s3_bucket_trg,
                                self.meta_key, self.source_config, self.target_config)
    ...
    def test_transform_report1_ok(self):
        ...
        """
        # Expected results
        log1_exp = 'Applying transformations to Xetra source data for report1 started...'
    ...
    def test_load(self):
        ...
        self.assertTrue(df_exp.equals(df_result))
        meta_file = self.s3_bucket_trg.read_csv_to_df(self.meta_key)[0]
